...
def add_questions():
    questions = [
        ...
        ('What is bigger than an elephant and weighs nothing?', 'An elephants shadow', 'A balloon', 'A parachute', 'A cloud')]
    open()
...
def get_question_after(question_id = 0, quiz_id=1):
    '''returns the necxt question after the question with the passed ID for the first question, the default value is passed'''
    open()
    query = '''
